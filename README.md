...
- **System file chooser:** run `strata --install-portal` to serve local file and folder requests from portal-aware applications; see [portal setup](docs/portal-file-chooser.md).
